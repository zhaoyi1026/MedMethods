##############################################################################
# MedMethods method module: multimodal
# Multimodal mediation analysis with two blocks of mediators
#
...
### ---- from multimodal/multimodal_integration-master/PathLasso.R ----
#########################################
...
# [MedMethods] removed at assembly: library("glmnet")
